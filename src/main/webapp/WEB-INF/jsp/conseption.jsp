...
<%--        <input type="hidden" name="id" value="${task.id}">--%>
        ...
        <input name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="titleHelp" placeholder="Enter title" required>
        <small id="emailHelp" class="form-text text-muted">You need this to identify your task</small>
    </div>
    <div class="form-group">
        <label for="exampleFormControlTextarea1">Text</label>
        <textarea name="text" class="form-control" id="exampleFormControlTextarea1" rows="20" required></textarea>
    </div>
